...
//			consoleLog(request);
			...
			if ("GET".equals(tokens[0])) {
				...
				reponseStaticResuorce(outputStream, tokens[1], tokens[2]);
			} else {
...
//			outputStream.write( "<h1>이 페이지가 잘 보이면 실습과제 SimpleHttpServer를 시작할 준비가 된 것입니다.</h1>".getBytes( "UTF-8" ) );
	...
	private void reponseStaticResuorce(OutputStream outputStream, String url, String protocol) throws IOException {
		if ("/".equals(url)) {
			url = "/index.html";
		}
